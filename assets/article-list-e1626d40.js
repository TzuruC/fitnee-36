import"./main-823c48ba.js";import"./animation-2ea199e6.js";import{a as i}from"./config-afd6d7d3.js";function s(){c()}s();const r=document.querySelector(".render-cards");let e=[];function c(){axios.get(`${i}/articles`).then(function(a){e=a.data;let l="";e.forEach(t=>{l+=n(t)}),r.innerHTML=`
