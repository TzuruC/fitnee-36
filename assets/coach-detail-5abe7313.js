import"./auth-01860cba.js";import"./animation-2ea199e6.js";import{a as s}from"./config-f552c1ba.js";const i=new URLSearchParams(window.location.search),l=i.get("id"),o=document.querySelector(".render-coach-detail");console.log(o);axios.get(`${s}/coaches/${l}`).then(function(a){let c=a.data;console.log(c),o.innerHTML=`
