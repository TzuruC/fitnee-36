import"./main-aa134d7c.js";import"./animation-2ea199e6.js";import{a as u}from"./config-afd6d7d3.js";function C(){L(),p()}C();const i=document.querySelector(".coach-cards");let o=[];function L(){axios.get(`${u}/coaches`).then(function(t){o=t.data;let e="",a=0;o.forEach(c=>{a<4&&(e+=s(c),a+=1)}),i.innerHTML=e}).catch(function(t){console.log(t)})}function s(t){return`
  ...
  `}const k=document.querySelector(".coach-filter-system");k.addEventListener("click",t=>{if(t.preventDefault(),t.target.nodeName=="A"){const e=t.target.textContent;let a="",c=0;o.forEach(r=>{r.coachTalent==e&&c<4&&(a+=s(r),c+=1)}),i.innerHTML=a}});const d=document.querySelectorAll(".coach-filter-system .filter-btn");d.forEach(t=>{t.addEventListener("click",e=>{e.preventDefault(),d.forEach(a=>{a.classList.remove("active")}),e.target.classList.add("active")})});const h=document.querySelector(".search-coach"),E=document.querySelector(".search-coach input");h.addEventListener("submit",t=>{t.preventDefault();const e=E.value.trim().toLowerCase();console.log(e);let a="",c=0;o.forEach(r=>{let g=r.coachName.toLowerCase().split(""),n=!1;g.forEach(y=>{y.includes(e)&&(n=!0)}),n&&c<4&&(a+=s(r),c+=1),i.innerHTML=a}),h.reset()});const m=document.querySelector(".article-cards");let l=[];function p(){axios.get(`${u}/articles`).then(function(t){l=t.data;let e="",a=0;l.forEach(c=>{a<4&&(e+=v(c),a+=1)}),m.innerHTML=e}).catch(function(t){console.log(t)})}function v(t){return`
  ...
  `}const x=document.querySelector(".article-filter");x.addEventListener("click",t=>{t.preventDefault();const e=t.target.textContent;if(e=="所有分類"){p();return}let a="",c=0;l.forEach(r=>{r.articleCategory==e&&c<4&&(a+=v(r),c+=1)}),m.innerHTML=a});const f=document.querySelectorAll(".article-filter li");f.forEach(t=>{t.addEventListener("click",e=>{e.preventDefault(),f.forEach(a=>{a.querySelector("a").classList.remove("link-primary","active")}),e.target.classList.add("link-primary","active")})});
