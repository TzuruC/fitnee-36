import"../main-76cd2f60.js";import"../auth-4e215fa2.js";import{a as e}from"../config-afd6d7d3.js";function n(){d()}n();const r=document.querySelector(".js-coachList");let c=[];function d(){axios.get(`${e}/coaches?_expand=user`).then(function(t){c=t.data,console.log(c);let o="";c.forEach(a=>{o+=s(a)}),r.innerHTML=o}).catch(function(t){console.log(t)})}function s(t){return`
    <tr>
