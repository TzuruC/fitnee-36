import"./main-aa134d7c.js";import"./animation-2ea199e6.js";import{a as s}from"./config-afd6d7d3.js";const i=new URLSearchParams(window.location.search),l=i.get("id"),o=document.querySelector(".render-coach-detail");console.log(o);axios.get(`${s}/coaches/${l}`).then(function(a){let c=a.data;console.log(c),o.innerHTML=`
